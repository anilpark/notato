...
export const SwaggerGetNotesInFolder = () =>
  applyDecorators(
    ApiQuery({
      type: Number,
      name: 'skip',
...
export const SwaggerCreateNote = () =>
  applyDecorators(
...
export const SwaggerGetFolders = () =>
  applyDecorators(
    ApiQuery({
      type: Number,
      name: 'skip',
...
export const SwaggerCreateFolder = () =>
  applyDecorators(
...
export const SwaggerDeleteFolder = () =>
  applyDecorators(
